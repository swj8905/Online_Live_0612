...
# youtube_link = "https://www.youtube.com/watch?v=DX0iBAABq_A"
# max_num = 20
...
if submit_button:
    ...
    fig = alt.Chart(df).mark_circle().encode(x="score", y="like", size=alt.Size('reply', scale=alt.Scale(domain=[1, df["reply"].max()])),
                                       color="reply", tooltip=["score", "like", "reply"])
    st.altair_chart(fig, use_container_width=True)
